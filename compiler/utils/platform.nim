...
type
  TSystemOS* = enum # Also add OS in initialization section and alias
    ...
    osNone, osDos, osWindows, osOs2, osLinux, osSolaris,
    osIrix, osNetbsd, osFreebsd, osOpenbsd, osDragonfly, osCrossos, osAix, osQnx,
    osMacos, osMacosx, osIos, osHaiku, osAndroid, osVxWorks,
